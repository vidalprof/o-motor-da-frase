...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/vr_comer.png?v=' + V + '" alt="">' + '<span class="rt">come</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/vr_correr.png?v=' + V + '" alt="">' + '<span class="rt">corre</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/vr_brincar.png?v=' + V + '" alt="">' + '<span class="rt">brincam</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/vr_ler.png?v=' + V + '" alt="">' + '<span class="rt">lê</span>' + '</div>' + '<div class="it" style="animation-delay:1.40s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/vr_estudar.png?v=' + V + '" alt="">' + '<span class="rt">anda</span>' + '</div>' + '</div>' + '<div class="esteira2">' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '</div>' +
